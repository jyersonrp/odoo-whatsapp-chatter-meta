...
# Integración de WhatsApp Chatter para Odoo (Meta WhatsApp Cloud API)

[![Odoo Version](https://img.shields.io/badge/Odoo-17.0%20%7C%2018.0%20%7C%2019.0-714B67.svg)](https://www.odoo.com)
[![License: LGPL-3](https://img.shields.io/badge/Licencia-LGPL--3-blue.svg)](LICENSE)
...
- **Soporte Bilingüe Completo (i18n)**:
  - Internacionalización estándar de Odoo en inglés (`en_US`) y español (`es`, `es_ES`).
  - Vistas, menús, acciones, estados de salud (`whatsapp_health_state`), botones y notificaciones totalmente traducidos.
...
El módulo incluye una suite integral de **204 pruebas automatizadas** que cubren:
- Verificación exhaustiva de internacionalización y archivos i18n (`.pot`, `en_US.po`, `es.po`, `es_ES.po`).
...
- Escalación y monitoreo de mensajes no respondidos vía cron.
...
├── data/
│   └── whatsapp_cron_data.xml # Acciones planificadas y crons
├── i18n/
│   ├── en_US.po               # Traducción al inglés
│   ├── es.po                  # Traducción al español (genérico)
│   ├── es_ES.po               # Traducción al español (España)
│   └── whatsapp_chatter_meta.pot # Plantilla base de traducciones
├── models/
│   ├── __init__.py
...
│   ├── test_whatsapp_e2e_tiers.py    # Tests de flujos E2E multinivel
│   ├── test_whatsapp_escalation.py   # Tests de escalación y cron
│   ├── test_whatsapp_i18n.py         # Tests de traducción y archivos PO/POT
│   ├── test_whatsapp_media_and_health.py # Tests de media y salud de ventana
...
Este módulo está licenciado bajo la **Licencia Pública General Reducida de GNU v3.0 (LGPL-3.0)**.
Se autoriza el uso comercial, la copia, distribución, modificación e integración del software conforme a los términos y condiciones estipulados en la LGPL-3.0.
